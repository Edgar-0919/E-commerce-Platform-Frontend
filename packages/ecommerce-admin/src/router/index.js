...
const routes = [
  ...
  },
  {
    path: '/admin/products',
    name: 'AdminProducts',
    component: () => import('@/views/GoodsManage/Products.vue'),
    meta: { title: '商品管理', requiresAuth: true, roles: ['ROLE_ADMIN', 'ROLE_MERCHANT'] }
  },
  {
    path: '/admin/products/create',
    name: 'AdminProductCreate',
    component: () => import('@/views/GoodsManage/ProductForm.vue'),
  ...
  },
  {
    path: '/admin/refunds',
    name: 'AdminRefunds',
    component: () => import('@/views/OrderManage/Refunds.vue'),
  ...
  },
  {
    path: '/admin/coupons',
    name: 'AdminCoupons',
    component: () => import('@/views/System/Coupons.vue'),
  ...
  
  {
    ...
    meta: { title: '商户管理', requiresAuth: true, roles: ['ROLE_ADMIN'] }
  }
]
