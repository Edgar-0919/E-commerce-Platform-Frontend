      ...
      <div class="detail-main">
        ...
        <div class="product-info">
          ...
          <div class="price-block">
            ...
            <div class="price-sub" v-if="product.originalPrice">
          ...
          <div v-if="activeTab === 'detail'" class="tab-panel">
            <div class="detail-content">
              ...
              <div class="detail-images">
                <img v-for="(img, index) in detailImages" :key="index" :src="img" alt="" loading="lazy" />
              </div>
            </div>
          </div>
          <div v-if="activeTab === 'spec'" class="tab-panel">
            <table class="spec-table">
              <tr><td class="spec-label">品牌</td><td>{{ product.brand || '未知' }}</td></tr>
              <tr><td class="spec-label">型号</td><td>{{ product.model || '未知' }}</td></tr>
              <tr><td class="spec-label">产地</td><td>{{ product.origin || '中国大陆' }}</td></tr>
              <tr><td class="spec-label">重量</td><td>{{ product.weight || '未知' }}</td></tr>
            </table>
          </div>
...
import { ShoppingCart, CreditCard, ArrowLeft, ArrowRight } from '@element-plus/icons-vue'
...
import { productImages, skuList, detailImages, reviews, relatedProducts } from '@/mock/product'
...
function nextImage() {
  if (currentImageIndex.value < productImages.length - 1) currentImageIndex.value++
}
...
async function handleAddToCart() {
  try {
    await addToCart({ skuId: selectedSku.value, quantity: quantity.value })
...
async function loadProduct() {
  ...
  try {
    ...
    Object.assign(product, {
      ...
      description: '苹果旗舰手机，搭载A17芯片，钛金属设计',
      price: 9999,
      originalPrice: 10999,
      discount: 9.1,
      sales: 12580
